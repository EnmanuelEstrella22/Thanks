...
public class GameManager : MonoBehaviour
{
 ...
 private TankManager m_GameWinner; //Referencia al ganador del juego para a nunciar quién ha ganado
    public string textFinalizado;
 private void Start()
    {
    ...
    private void SpawnAllTanks()
    {
        ...
        {
            //...los creo, ajusto el número de jugador y ls referencias necesa rias para controlarlo
 ...
 private TankManager GetRoundWinner()
    ...
    private TankManager GetGameWinner()
    {
        ...
        if (m_Tanks[i].m_Wins == 3)
            {
                textFinalizado = m_RoundWinner.m_ColoredPlayerText + " GANA LA PARTIDA!";
                return m_Tanks[i];
            }
        }
        // Si no, devuelvo null.
